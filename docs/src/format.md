...
| `Type`                     | Type of the generator (string). For thermal generators, this must be `Thermal` or `thermal`.  | Required | N
...
| :---------------- | :------------------------------------------------ | :------: | :------------:
| `Bus`             | Identifier of the bus where this generator is located (string). | Required | N
| `Type`            | Type of the generator (string). For profiled generators, this must be `Profiled` or `profiled`.  | Required | N
