...
| `Planning horizon (year)`                          | Length of transmission planning horizon in years. |   Optional    |      No      |    ---     |
| `Discount rate`                          | Annual discount rate. |   Optional    |      No      |    ---     |
...
This section describes the characteristics of transmission system, such as its topology and the susceptance of each transmission line. If a line can be built multiple times, then that many copies of the struct should be included in the data file.
