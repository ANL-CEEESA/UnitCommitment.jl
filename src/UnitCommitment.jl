...
include("components/flexiramp/structs.jl")
...
include("components/flexiramp/build.jl")
include("components/flexiramp/read.jl")
include("components/flexiramp/slice.jl")
include("components/flexiramp/solution.jl")
include("components/flexiramp/summarize.jl")
include("components/flexiramp/validate.jl")
