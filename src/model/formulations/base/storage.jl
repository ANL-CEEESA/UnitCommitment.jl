...
function _add_storage_unit!(
	...
	if su.invest[1] > 0.0
		...
		eq_invest_storage_nondecreasing = _init(model, :eq_invest_storage_nondecreasing)
		eq_invest_storage_level_upper = _init(model, :eq_invest_storage_level_upper)
		eq_invest_storage_level_lower = _init(model, :eq_invest_storage_level_lower)
