...
function _add_transmission_line!(
	...
	eq_invest_line_flow_limit_upper = _init(model, :eq_invest_line_flow_limit_upper)
	eq_invest_line_flow_limit_lower = _init(model, :eq_invest_line_flow_limit_lower)

	if lm.invest[1] > 0.0
		invest_line = _init(model, :invest_line)
		eq_invest_line_nondecreasing = _init(model, :eq_invest_line_nondecreasing)
