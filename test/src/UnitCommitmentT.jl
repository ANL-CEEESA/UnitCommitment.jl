...
include("components/virtual/build_test.jl")
include("components/virtual/read_test.jl")
include("components/virtual/slice_test.jl")
include("components/storage/build_test.jl")
include("components/storage/read_test.jl")
include("components/storage/slice_test.jl")
include("components/interface/read_test.jl")
include("components/interface/build_test.jl")
include("components/interface/flow_test.jl")
include("components/interface/slice_test.jl")
...
include("components/thermal/summary_test.jl")
...
include("transmission/dc/powermodels_util.jl")
include("transmission/dc/phaseangle/build_test.jl")
include("transmission/dc/phaseangle/flow_test.jl")
include("transmission/dc/phaseangle/powermodels_test.jl")
include("transmission/read_test.jl")
include("transmission/slice_test.jl")
...
include("transmission/dc/shiftfactors/powermodels_test.jl")
