...
function runtests()
    ...
    @testset "UnitCommitment" begin
        ...
        # # solution_methods_TimeDecomposition_initial_status_test() # key not found error
        # # solution_methods_TimeDecomposition_optimize_test() # key not found error
        ...
        # lmp_aelmp_test()
        # simple_market_test()
        # # stochastic_market_test() # key not found error
        model_planning_test()
        # model_planning_test_bench_table()
    end
    return
end
