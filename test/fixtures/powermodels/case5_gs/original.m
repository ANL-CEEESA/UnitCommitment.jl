% Case5 with shunt conductance (Gs=5.0) on bus 2 for DC validation.
% Based on case5/original.m with only Gs modification.

function mpc = case5_gs
mpc.version = '2';
mpc.baseMVA = 100.0;
...
mpc.bus = [
	...
	2	 1	 300.0	 98.61	 5.0	 0.0	 1	    1.08407	   -0.73465	 230.0	 1	    1.10000	    0.90000;
